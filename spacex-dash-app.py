...
import numpy as np
marks = {int(x): str(int(x)) for x in np.linspace(0, 10000, 11)}
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Evaluate total successful launches by site
        ...
        # Filter out launches from selected site
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        # Replaces 0s and 1s with "Failure" and "Success" and count number of each
